 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Skel
...
add_action( 'tgmpa_register', 'skel_register_required_plugins' );
 ...
 */
function skel_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'skel',                 // Unique ID for hashing notices for multiple instances of TGMPA.
